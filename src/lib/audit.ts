...
const ACTION_TITLES: Record<string, string> = {
  ...
  gang_application_submitted: "Gang · Application submitted",
  gang_application_approved: "Gang · Application approved",
  gang_application_rejected: "Gang · Application rejected",
  job_discord_roles_updated: "Site · Job Discord roles updated",
